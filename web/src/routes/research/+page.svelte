...
<svelte:head>
	<title>Research - Climate Explorer</title>
	<meta
		name="description"
...
<div class="space-y-8">
	...
	<div class="text-center max-w-3xl mx-auto">
		...
		<p class="text-lg opacity-80">
			In-depth analysis of 150+ cities worldwide, covering climate data, livability rankings, and
			hidden gems for those seeking the ideal moderate-climate destination.
		</p>
	</div>
